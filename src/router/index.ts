  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'mi-progreso',
        name: 'my-progress',
        component: () => import('@/views/dashboard/ProgressView/index.vue'),
        meta: {
          requiresActiveAccess: true,
          title: 'Mi progreso | Luisa Pita Bejarano',
          description: 'Registra tus medidas y pruebas físicas y mira tu progreso mensual.',
          canonical: `${SITE}/app/mi-progreso`,
          ogTitle: 'Mi progreso | Luisa Pita Bejarano',
          ogDescription: 'Registra tus medidas y pruebas físicas y mira tu progreso mensual.',
          ogUrl: `${SITE}/app/mi-progreso`,
          ogImage: OG_IMAGE,
        } satisfies RouteMeta,
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {
          title: 'Admin - Valoraciones | Luisa Pita Bejarano',
          description: 'Seguimiento del registro mensual de valoraciones físicas.',
          canonical: `${SITE}/admin/valoraciones`,
          ogTitle: 'Admin - Valoraciones | Luisa Pita Bejarano',
          ogDescription: 'Seguimiento del registro mensual de valoraciones físicas.',
          ogUrl: `${SITE}/admin/valoraciones`,
          ogImage: OG_IMAGE,
        } satisfies RouteMeta,
      },
      {
        path: 'valoraciones/:userId',
        name: 'admin-assessment',
        component: () => import('@/views/admin/AdminAssessmentView/index.vue'),
        meta: {
          title: 'Admin - Valoración física | Luisa Pita Bejarano',
          description: 'Valoración física y progreso mensual de la alumna.',
          canonical: `${SITE}/admin/usuarios`,
          ogTitle: 'Admin - Valoración física | Luisa Pita Bejarano',
          ogDescription: 'Valoración física y progreso mensual de la alumna.',
